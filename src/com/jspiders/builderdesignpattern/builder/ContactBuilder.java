...
public class ContactBuilder {
	...
	public  ContactBuilder first_name(String first_name){
	 ...
	 public ContactBuilder lemail(String email) {
			this.email=email;
			return this;
		}
	...
	public Contact getContact() {
		...
		Contact contact=new Contact(this.first_name,this.middle_name,this.last_name,this.nickname,this.email,this.mobile_no,this.landline_no,this.dob,this.company,this.address,this.gender);
		return contact;
